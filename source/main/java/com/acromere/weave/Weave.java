...
public class Weave extends Application implements Product {
	...
	private com.acromere.util.Parameters parameters;
	...
	void start( String... commands ) {
		...
		// Parse parameters
		this.parameters = com.acromere.util.Parameters.parse( commands );
	...
	private void configureLogging( com.acromere.util.Parameters parameters ) {
		Log.configureLogging( this, parameters, null, DEFAULT_LOG_FILE_PATTERN );
		Log.setPackageLogLevel( "com.acromere", parameters.get( LogFlag.LOG_LEVEL, LogFlag.INFO ) );
	}
